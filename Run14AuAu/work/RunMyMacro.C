...
void RunMyMacro(const char *modulemacro = "Run_EP_Run14AuAu.C",
                const char *outfile = "test_vnres_run14auau.root",
                const int nevnt = 100000,
                const char *system  = "Run14AuAu200CAMBPro109")
